              ...
              <div className="relative">
                ...
                >
                  {appUser?.avatarUrl || user.user_metadata?.avatar_url ? (
                    <Image src={appUser?.avatarUrl || user.user_metadata.avatar_url} alt={user.user_metadata.full_name || ''} width={28} height={28} className="rounded-full object-cover" unoptimized />
                  ) : (
